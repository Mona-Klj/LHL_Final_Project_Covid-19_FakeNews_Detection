...
### Deploying by Flask
And in the last step, I deployed my model with a Flask web app. You can run <a href="">Fake_News_Det.py</a> in root directory with model.pkl to see the web app runnig.
